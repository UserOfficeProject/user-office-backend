...
BEGIN
  ...
  INSERT INTO users(
    user_id, user_title, middlename, firstname, lastname, username, password, preferredname, oidc_sub, oidc_refresh_token, gender, birthdate, department, "position", email, 
